...
export default class ResetPassword extends React.Component {
    ...
    checkToken(email, token) {
        ...
        let url = `http://talentserviceidentity.azurewebsites.netauthentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `http://talentserviceidentity.azurewebsites.netauthentication/authentication/resetpassword?o=${email}&p=${token}`;
